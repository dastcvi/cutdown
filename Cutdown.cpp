...
void Cutdown::arm(void)
{
    ...
    oled.clear();
    oled.write_line("ARMING: GPS WAIT", LINE1);
...
void Cutdown::cutdown(void)
{
    ...
    // todo: place in init and update as needed in unarmed
    ...
    attiny.arm(); // todo: update attiny software to expect hw signal instead
